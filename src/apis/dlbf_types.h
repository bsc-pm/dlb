...
!-------------------------------------------------------------------------------!
      ...
      ! For now it's just talp types.
      ! In future releases it will contain all types but we're waiting because
      ! it may break how applications currently include our headers.
